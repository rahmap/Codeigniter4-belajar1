                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-flag-dropdown"
                            ...
                            <img class="" src="<?= base_url('apaxy/images/flags/us.jpg') ?>" alt="Header Language"
                                height="14">
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?= base_url('apaxy/images/flags/spain.jpg') ?>" alt="user-image" class="mr-2"
                                    height="12"><span class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?= base_url('apaxy/images/flags/germany.jpg') ?>" alt="user-image" class="mr-2"
                                    height="12"><span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?= base_url('apaxy/images/flags/italy.jpg') ?>" alt="user-image" class="mr-2"
                                    height="12"><span class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?= base_url('apaxy/images/flags/russia.jpg') ?>" alt="user-image" class="mr-2"
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="<?= base_url('apaxy/images/users/avatar-3.jpg') ?>"
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="<?= base_url('apaxy/images/users/avatar-4.jpg') ?>"
                                            class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <span class="d-none d-sm-inline-block ml-1"><?= 'aan' ?></span>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url('calender') ?>" class=" waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="<?= base_url('list-user') ?>">List User</a></li>
                ...
                <div class="tab-pane active" id="chat-tab" role="tabpanel">
                    ...
                    <div class="p-2">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-10.jpg') ?>"
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-1.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-9.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                    ...
                    <div class="p-2 pb-4">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-2.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-5.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('') ?>apaxy/images/users/avatar-6.jpg"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-7.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status busy"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="<?= base_url('apaxy/images/users/avatar-8.jpg') ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status away"></i>
                                </div>
                                <div class="media-body overflow-hidden">
